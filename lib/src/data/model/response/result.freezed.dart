...
class _$ResultTearOff {
  ...
  Failure<T> failure<T>({required T err}) {
    return Failure<T>(
      err: err,
    );
  }
...
mixin _$Result<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(T err) failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult Function(T data)? success,
    TResult Function(T err)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$Failure<T> extends Failure<T> {
  const _$Failure({required this.err}) : super._();
  ...
  @override
  String toString() {
    return 'Result<$T>.failure(err: $err)';
  }
...
abstract class Failure<T> extends Result<T> {
  const factory Failure({required T err}) = _$Failure<T>;
