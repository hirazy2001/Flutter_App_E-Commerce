...
class OtpScreenState extends State<OtpScreen> with CodeAutoFill {
  ...
  bool isEmail() {
    return AppUtils.regexStr(
        widget.emailOrPhone.emailOrPhone, Common.REGEX_EMAIL);
  }
                            ...
                            children: [
                              ...
                              ButtonMaterial(
                                ...
                                onClick: () {
                                  // authOtpBloc.add(OtpAuthEvent(
                                  //     otpAuth: OtpAuth(
                                  //         email:  isEmail() ? widget.emailOrPhone.emailOrPhone : null,
                                  //         phone: !isEmail() ? widget.emailOrPhone.emailOrPhone : null,
                                  //         otp:
                                  //     )
                                  // ))
                                },
